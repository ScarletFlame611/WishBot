...
# на всякий случай старые варианты некоторых переменных
'''
    five_chance = {1: 0.600, 2: 0.596, 3: 0.592, 4: 0.591, 5: 0.586, 6: 0.582, 7: 0.579, 8: 0.575,
                   ...
                   72: 0.392, 73: 0.388, 74: 0.387, 75: 0.384, 76: 20.627, 77: 13.946, 78: 9.429,
                   79: 6.375, 80: 4.306, 81: 2.914, 82: 1.970, 83: 1.332, 84: 0.901, 85: 0.608,
                   86: 0.411, 87: 0.278, 88: 0.187, 89: 0.126, 90: 100}
                   
    probability5 = sum([five_chance[i] for i in range(1, until5 + 1)])
    probability4 = sum([10 for i in range(until4)])
